...
public class CargaArchivosADM extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //processRequest(request, response);
            ...
            // String archivourl = "C:\\SUN\\ODI";// Pruebas
            String archivourl = "/home/shares/ODI"; // produccion
                 ...
                 for(FileItem items: partes){
                     ...
                     if(usr.equals("1")){
                               //response.sendRedirect("/planeacion/editpr?idp="+idart+"#collapseFive");
                                response.sendRedirect("/planeacion/detalleproyadm?idp="+idart+"#collapseEight");
                     }else{
                              //  response.sendRedirect("/planeacion/detalleproy?idp="+idart+"#collapseNine");
                     }
