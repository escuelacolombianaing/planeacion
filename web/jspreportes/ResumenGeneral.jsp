...
<html>
    ...
    <center>
        ...
        <%if(formato == null || (!formato.equals("excel"))){%>
            <center>
                <button class="btn btn-group-vertical" onclick="location.href='/planeacion/ResumenGeneral?formato=excel'">Descargar Reporte</button>  -     <button class="btn btn-group-vertical" onclick="window.close();"> Cerrar</button>    
            </center>
        <%}%>
        ...
        <table border="2">
        <tr>
            <th bgcolor="#8B0D04"><font color="#FFFFFF"><center> Plan [Unidad Ejecutora] </center></font></th>
        ...
        <%for(int k = 0 ; k < unidadejec.size() ; k++){
             ...
             valores = bd.ConsultaValoresPlanReporteGen(aux.elementAt(0).toString(), aux2.elementAt(0).toString(),"5");
             if(valores.size()>0){
        %>
        <tr>
